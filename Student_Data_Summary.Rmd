...
rank <- c(19,18,20,8,6,7,16,14,15,3,5,10,4,12,11,17,13,2,9,21,1)
...
modelResultsSummary <- data.frame(rank,model,accuracy,type)

#sort the importance dataframe by the calculated importance 
modelResultsSummary <- modelResultsSummary %>% arrange(rank)

kable(modelResultsSummary)
```
