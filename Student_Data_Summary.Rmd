...
packages=c("tidyverse", "ggplot2", "mclust", "rpart", "rpart.plot", "caret", "arules", "arulesViz", "corrplot", "Hmisc")
...
train_m <- train_m[complete.cases(train_m), ]
train.cor <- cor(train_m, method=c("spearman"))
heatmap(train.cor)
```
