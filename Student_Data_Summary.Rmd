...
The concept of education has evolved significantly over the centuries. From the ancient and medieval periods, where it was a privilege of the few, to the modern era, education is now widely recognized as a fundamental right. The evolution of school systems reflects the changing societal values and the increasing emphasis on accessible education for all. Educational models have continuously adapted to these societal changes, striving to provide equitable learning opportunities and to foster environments where diverse student populations can thrive.

Students face challenges that affect drop-out and graduation, such as demographics, socio-economic factors, academic progress, and the macro-economic environment.

Graduation is a major life milestone that can greatly affect the direction of a student's life. It can be a firm start on building a career in a fulfilling profession. It can provide access to a wider range of professions.

Understanding factors leading to drop-out or graduation is important for all stakeholders: students, families, schools, and society as a whole.

Parents have aspirations for their children. Building awareness of the factors leading to drop-out, parents can provide support where it is most effective.

Schools are interested in seeing students becoming successful alumni. By understanding factors leading to drop out, schools can provide early intervention to improve graduation rates.

Increasing the gradution rates and decreasing the drop-out rate leads to a skilled workforce benefiting Society as a whole.

## Research Questions

Can data mining techniques accurately identify key predictors, their interactions, and parameter ranges of concern?

* What factors influence a student to drop-out?
* What distinguishable combination of factors could predict a drop out event?
* Which machine learning models provide accurate predictions?
...
There are robust measures covering Demographics, Social-Economic data, Academic progress tracking, and External Macro-economic environment. The target variable indicates whether a student dropped out or achieved academic success. The data spans multiple semesters.  Researchers can leverage this dataset to develop models for predicting dropout and academic success, contributing to the understanding of factors influencing educational outcomes. The data comes from educational institutions in Portugal.

Academic progress tracking is measured through a multi-step process of credit attainment.
...
```
## Factors that influence drop-out

Several models highlighted the same factors which seem to affect
drop-out likelihood. Critical predictors include parents'
qualificationa dn occupations, age, approved academic load or
performance, and financial considerations.

The ARM Rules provided factors that were used for Decision Tree and
Binomial Regression models to achieve respectable accuracy.

| Factors That influence Dropout |Combinations that predict Dropout |                       Best Models to Predict Dropout |            
| ------------------------------ | -------------------------------- |              	    ------------------------------ |
| Age.at.Enrollment |		  Age.at.enrollment=[38.2,48.8) |                           ARM Rules |                               
| Father.s.qualification |	  Curricular.units.2nd.sem..grade.=[0,3.71) |               Decision Tree (72% accuracy) |            
| Curricular.units.2nd.sem |	  Father.s.qualification=[26.8,35.4) |                      Binomial Regression (best, 85% accuracy) |
| Tuition.Fees.up.to.date |	  Curricular.units.2nd.sem..grade.=[0,3.71) |           
| Mother.s.qualification |	  Previous.qualification=Higher education – degree |    
| Mother.s.occupation |		  Curricular.units.2nd.sem..approved.=[0,4) |           
				  Tuition.fees.up.to.date=[0,0.2) |                     

\pagebreak
# Conclusions & Key Take-Aways

Some factors such as parent's qualifications and occupations are not
something that can be controled by a school. Academic performance is a
non-surprising predictor.

Parents can provide inspiration in their own academic and professional
qualifications.

Age at enrollment in the range of 38-48 corresponds to higher life
demands. It can be difficult for older students to balance academics
with their other obligations. There could also be a financial factor
here, as older students are generally responsible for their own
tuition and fees.

Tuition not up to date is a major factor for predicting
drop-out. Financial condition is the one area where schools and
society as a whole can perhaps apply some leverage.
