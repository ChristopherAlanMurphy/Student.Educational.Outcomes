...
```{r echo=FALSE, label='model-svm-linear-confusionmatrix', cache=TRUE}
...
```{r echo=FALSE, label='model-svm-linear-tune', cache=TRUE}
...
```{r echo=FALSE, label='model-svm-poly-stats', cache=TRUE}
...
```{r echo=FALSE, label='model-svm-poly-confusionmatrix', cache=TRUE}
# View confusion matrix of out-of-fold predictions
...
The second mbinomial logistic regression mode is built to fit the outcome "Dropout" attribute using predictor attributes present in strong and significant rules found during association rule mining above.
...
```{r echo=FALSE}
modelname <- c("Random Guess", 
               "Most Common Value", 
               "K-means", 
               "Decision Tree", 
               "Support Vector Machine - Linear", 
               "Support Vector Machine - Polynomial",
               "Naive Bayes, K-Fold, Non-PCA", 
               "Naive Bayes, K-Fold, Selected-PCA", 
               "Naive Bayes, K-Fold, PCA", 
               "Random Forest, K-Fold, Non-PCA", 
               "Random Forest, K-Fold, PCA", 
               "Random Forest, K-Fold, Selected PCA",
               "Random Forest, Variable Tree Numbers, Non-PCA",
               "Random Forest, Variable Tree Numbers, Selected PCA",
               "Random Forest, Variable Tree Numbers, PCA",
               "KNN, non-PCA",
               "KNN PCA",
               "Multinomial Logistic Regression - All Attributes",
               "Multinomial Logistic Regression - Select Attributes",
               "Biinomial Logistic Regression - All Attributes",
               "Biinomial Logistic Regression - Select Attributes")
...
accuracyrank <- c(19,18,20,8,6,7,16,14,15,3,5,10,4,12,11,17,13,2,9,21,1)
...
modelResultsSummary <- data.frame(accuracyrank,modelname,modelaccuracy,modeltype,comments)

#sort the importance dataframe by the calculated importance 
modelResultsSummary <- modelResultsSummary %>% arrange(accuracyrank)
